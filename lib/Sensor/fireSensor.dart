...
class FireSensor extends StatefulWidget {
  const FireSensor({super.key});

  @override
  State<FireSensor> createState() => _FireSensorState();
}

class _FireSensorState extends State<FireSensor> {
  List<int>? allData;
