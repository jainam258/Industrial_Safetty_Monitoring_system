...
class mq135sensor extends StatefulWidget {
  const mq135sensor({super.key});

  @override
  State<mq135sensor> createState() => _mq135sensorState();
}

class _mq135sensorState extends State<mq135sensor> {
  List<int>? allData;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            "MQ135 Sensor Detect Air Quality above limit",
            style: TextStyle(color: Colors.red),
          ),
