...
class SmokeSensor extends StatefulWidget {
  const SmokeSensor({super.key});

  @override
  State<SmokeSensor> createState() => _SmokeSensorState();
}
...
class _SmokeSensorState extends State<SmokeSensor> {
  ...
  void getData() async {
    ...
    try {
      http.Response response = await http.get(Uri.parse("https://www.randomnumberapi.com/api/v1.0/random?min=100&max=1000&count=5"));
